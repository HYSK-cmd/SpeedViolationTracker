...
### To-Dos
    - overlay the roi image to the original frame to limit the detection area
    - add more constraints to polygon shaping policies
    - create detection lines based on a customized polygon area
