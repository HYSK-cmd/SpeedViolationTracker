...
# 04-06-2026
## UI Development
    - Created a simple UI web generated by Claude
    - Mode switching (video/livestream)
    - Model selection (currently have 4)
    - Running Detection requires as follows:
        - For videos
            - Video, Output Filename(must include video file ext), Model
        - For livestream
        - Model
